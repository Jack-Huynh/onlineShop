...
<form action="../../Controller/loginController.php?action=register" method="POST">
  <div class="container">
    ...
    <?php
      ...
      if($error==1) {
        echo '<div class="alert alert-danger"><strong>Please enter correct repassword</strong></div>';
      }
      if($error==2) {
  ...
  <div class="container signin">
    <p>Already have an account? <a href="http://localhost/onlineShop/onlineShop/View/login/loginPage.php">Sign in</a>.</p>
  </div>
</form>
